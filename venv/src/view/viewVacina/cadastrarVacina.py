...
class Ui_Cadastrar(object):
    def setupUi(self, Cadastrar):
        ...
        self.validade.setGeometry(QtCore.QRect(340, 80, 91, 20))
        ...
        self.campoVolume.setGeometry(QtCore.QRect(110, 120, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.campoValidade = QtWidgets.QTextEdit(self.frame)
        self.campoValidade.setGeometry(QtCore.QRect(440, 70, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.campoValidade.setFont(font)
        ...
        def insert():
            ...
            vacina = Vacina(1, nomeVacina, fabricante, validade, volume)
            VacinaController.controllerVacina(vacina)

            msg = QMessageBox()
            # msg.setIcon(QMessageBox.information)
            msg.setText("Vacina Adicionada")
            msg.setWindowTitle("Adicionar Vacina")
