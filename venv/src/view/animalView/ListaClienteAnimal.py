...
class ListaClienteAnimal(object):
    def setupUi(self, Cadastrar):
        ...
        self.btnSelecionar = QtWidgets.QPushButton(parent=self.container)
        ...
        self.btnSelecionar.clicked.connect(self.SelecionarCliente)
