...
# Form implementation generated from reading ui file 'AtualizarVeterinário.ui'
#
...
class Ui_AtualizarVeterinario(object):
    def setupUi(self, CadastrarCliente):
        ...
        self.btnAtualizar.setGeometry(QtCore.QRect(30, 410, 141, 61))
    ...
    def update(self):
        self.idcampo
        nome = self.campoNome.toPlainText()
        ...
        vet = Veterinario(self.idcampo, nome, cpf,
    ...
    def retranslateUi(self, CadastrarCliente):
        ...
        self.txtCadastrar.setText(_translate(
            "CadastrarCliente", "Atualizar Vaterinário"))
