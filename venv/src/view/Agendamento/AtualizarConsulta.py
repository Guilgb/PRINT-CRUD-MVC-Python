...
class Ui_Cadastrar(object):
    def setupUi(self, Cadastrar):
        ...
        self.buscaAnimal.setGeometry(QtCore.QRect(10, 90, 131, 21))
        ...
        self.retorno.setGeometry(QtCore.QRect(10, 270, 141, 20))
        ...
        self.buscaCliente.setGeometry(QtCore.QRect(10, 150, 191, 21))
        ...
        self.campoBuscarAnimal.setGeometry(QtCore.QRect(160, 80, 441, 41))
        ...
        self.campoBuscarCliente.setGeometry(QtCore.QRect(210, 140, 391, 41))
        ...
        self.campoBuscarAnimal_2 = QtWidgets.QTextEdit(parent=self.frame)
        self.campoBuscarAnimal_2.setGeometry(QtCore.QRect(160, 20, 111, 41))
        self.campoBuscarAnimal_2.setStyleSheet("position: absolute;\n"
                                               "width: 692px;\n"
                                               "height: 51px;\n"
                                               "left: 625px;\n"
                                               "top: 264px;\n"
                                               ...
                                               "background: #D9D9D9;\n"
                                               "border-radius: 8px;")
        self.campoBuscarAnimal_2.setObjectName("campoBuscarAnimal_2")
        self.IDConsulta = QtWidgets.QLabel(parent=self.frame)
        self.IDConsulta.setGeometry(QtCore.QRect(10, 30, 141, 21))
        self.IDConsulta.setStyleSheet("position: absolute;\n"
                                      "width: 184px;\n"
                                      "height: 24px;\n"
                                      "left: 420px;\n"
                                      "top: 277px;\n"
                                      ...
                                      "\n"
                                      "color: #000000;")
        self.IDConsulta.setObjectName("IDConsulta")
    ...
    def retranslateUi(self, Cadastrar):
        ...
        self.txtCadastrar.setText(_translate(
            "Cadastrar", "Atualizar Consulta"))
        self.buscaAnimal.setText(_translate("Cadastrar", "NOME ANIMAL"))
        ...
        self.IDConsulta.setText(_translate("Cadastrar", "ID CONSULTA"))
