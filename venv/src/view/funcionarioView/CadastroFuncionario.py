...
# Form implementation generated from reading ui file 'CadastrarFuncionario.ui'
#
...
from src.view.funcionarioView.ListarFuncionario import Ui_ListarFuncionario
...
class Ui_CadastrarFuncionario(object):
    def setupUi(self, CadastrarCliente):
        ...
        self.campoTelefone.setGeometry(QtCore.QRect(130, 260, 251, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.btnListar.clicked.connect(self.listarFuncionario)

    def listarFuncionario(self):
        self.janela_listar_funcionario = QtWidgets.QMainWindow()
        self.listar_funcionario = Ui_ListarFuncionario()
        self.listar_funcionario.setupUi(self.janela_listar_funcionario)
        self.janela_listar_funcionario.show()
    ...
    def insert(self):
        ...
        funcionario = Funcionario(
            1, nomeFuncionario, nascimento, email, telefone, cargo)
        FuncionarioController.controllerFuncionario(funcionario)

        msg = QMessageBox()
        # msg.setIcon(QMessageBox.information)
        msg.setText("Funcionario Adicionada")
        msg.setWindowTitle("Adicionar Funcionario")
    ...
    def retranslateUi(self, CadastrarCliente):
        ...
        self.txtCadastrar.setText(_translate(
            "CadastrarCliente", "Cadastrar Funcionario"))
        self.nome.setText(_translate(
            "CadastrarCliente", "NOME DO FUNCIONARIO"))
