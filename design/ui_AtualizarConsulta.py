...
"border-radius: 8px;")
        ...
        self.campoBuscarAnimal_2 = QtWidgets.QTextEdit(self.frame)
...
"border-radius: 8px;")
        ...
        self.IDConsulta = QtWidgets.QLabel(self.frame)
...
"color: #FFFFFF;")
    ...
    def retranslateUi(self, Cadastrar):
        ...
        self.txtCadastrar.setText(_translate("Cadastrar", "Atualizar Consulta"))
